...
- Some SQL expressions will translate only when `tidyverse` is set to `TRUE`. This includes `COUNT(DISTINCT )` expressions with multiple arguments, and `CASE` expressions.
